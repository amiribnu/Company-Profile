...
export default function EditPartnership(props) {
    const { partnership } = usePage().props;
    const imageRef = React.useRef();
    const [imagePreview, setImagePreview] = useState(null);
    const { data, setData, errors } = useForm({
        card_name: "Partnership",
    ...
    function handleSubmit(e) {
        ...
        router.post(
            route("webSetting.update", { CmsIndex: partnership.id }),
            form,
            {
                // notif
                onSuccess: () => {
                    ...
                    >
                        ...
                        <div className="grid sm:grid-cols-12 gap-2 sm:gap-6">
                            ...
                            <div className="sm:col-span-10">
                                ...
                                <ImagePreview imagePreview={imagePreview} oldImage={partnership.image} />
                            </div>
                            {/* End Image */}
                        </div>
                        {/* End Grid */}
