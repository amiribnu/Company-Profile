...
export default function EditCertificate(props) {
    ...
    function handleSubmit(e) {
        ...
        router.post(
            route("webSetting.certificate.update", {
                CmsIndex: certificate.id,
            }),
            form,
            {
                // notif
                    ...
                    >
                        ...
                        <div className="grid sm:grid-cols-12 gap-2 sm:gap-6">
                            ...
                            <div className="sm:col-span-10">
                                ...
                                <ImagePreview imagePreview={imagePreview} oldImage={certificate.image} />
                            </div>
                            {/* End Image */}
                        </div>
                        {/* End Grid */}
